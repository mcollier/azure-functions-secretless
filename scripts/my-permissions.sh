...
az role assignment create --assignee $assigneeId --role $storageQueueRoleDefinitionId --scope $storageAccountResourceId
az role assignment create --assignee $assigneeId --role $storageBlobRoleDefinitionId --scope $storageAccountResourceId
az role assignment create --assignee $assigneeId --role $eventHubRoleDefinitionId --scope $eventHubResourceId